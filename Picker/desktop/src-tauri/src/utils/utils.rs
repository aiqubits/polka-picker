...
pub fn determine_log_level(message: &str) -> &'static str {
    ...
    if message_lower.contains("info:") || message_lower.contains("[info]") || message_lower.contains("debug:") || message_lower.contains("[debug]") {
        "info"
              ...
              message_lower.contains("警告:") || message_lower.contains("警告") {
        "warning"
              ...
              message_lower.contains("write-error") || message_lower.contains("categoryinfo") || 
              message_lower.contains("fullyqualifiederrorid") {
        "error"
    } else {
